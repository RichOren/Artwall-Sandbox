...
(function() {
   ...
   Phoria.View.addMouseEvents = function addMouseEvents(el, fnOnClick, fnOnDown, fnOnUp)
   {
      if (el.id)
      {
         ...
         mouse.onMouseMove = function onMouseMove(evt) {
         	mouse.positionX = evt.clientX + document.body.scrollLeft;
         	mouse.velocityH = mouse.velocityLastH + (mouse.positionX - mouse.clickPositionX) * 0.5;
         	mouse.positionY = evt.clientY + document.body.scrollTop;
         ...
         mouse.onMouseDown = function onMouseDown(evt) {
            ...
            //console.log(evt.clientY, document.body.scrollTop, document.documentElement.scrollTop);
         	mouse.clickPositionX = evt.clientX + document.body.scrollLeft;
         	mouse.velocityLastH = mouse.velocityH;
         	mouse.clickPositionY = evt.clientY + document.body.scrollTop;
